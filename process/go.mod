...
require (
	...
	github.com/ochinchina/supervisord/config v0.0.0-20260914122518-a64219542f0d
...
require (
	...
	github.com/ochinchina/supervisord/util v0.0.0-20260827023808-368eb5d6ad92 // indirect
